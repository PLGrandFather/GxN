...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
os.system('cls')
os.system('mode con:cols=97 lines=15')
...
def una():
	print GxN
	os.system('ping localhost -n 1 > nul')
	os.system('cls')
	print xtra
	os.system('ping localhost -n 1 > nul')
	os.system('cls')
...
#I saw d3hydr8's code and its also the same xD
	...
	os.system('mode con:cols=81 lines=32')
	os.system('cls')
#GrandFatherXNightmare
...
# + ================================================================================= +
	...
	os.system('cls')
	os.system('mode con:cols=97 lines=10')
...
#vildz rhughndume ascii sthringh
	...
	def gfdosusage():
		...
		print term.RED+"............................................."
		print term.RED+".."+term.BLUE+"#######"+term.RED+".."+term.RED+"#######"+term.RED+".."+term.BLUE+"######"+term.RED+"...."+term.BLUE+"#####"+term.RED+"...."+term.BLUE+"#####"+term.RED+"."
		print term.RED+"."+term.BLUE+"##"+term.RED+"........"+term.BLUE+"##"+term.RED+"......."+term.BLUE+"##"+term.RED+"..."+term.BLUE+"##"+term.RED+".."+term.BLUE+"##"+term.RED+"..."+term.BLUE+"##"+term.RED+".."+term.BLUE+"#"+term.RED+"......"
		print term.RED+"."+term.BLUE+"##"+term.RED+"..."+term.BLUE+"###"+term.RED+".."+term.BLUE+"######"+term.RED+"..."+term.BLUE+"##"+term.RED+"..."+term.BLUE+"##"+term.RED+".."+term.BLUE+"##"+term.RED+"..."+term.BLUE+"##"+term.RED+".."+term.BLUE+"######"+term.RED+"."
		print term.RED+"."+term.BLUE+"##"+term.RED+"....."+term.BLUE+"#"+term.RED+".."+term.BLUE+"##"+term.RED+"......."+term.BLUE+"##"+term.RED+"..."+term.BLUE+"##"+term.RED+".."+term.BLUE+"##"+term.RED+"..."+term.BLUE+"##"+term.RED+"......."+term.BLUE+"#"+term.RED+"."
		print term.RED+".."+term.BLUE+"#####"+term.RED+"."+term.BLUE+"#"+term.RED+".."+term.BLUE+"##"+term.RED+"......."+term.BLUE+"######"+term.RED+"...."+term.BLUE+"#####"+term.RED+"..."+term.BLUE+"#####"+term.RED+".."
		print term.RED+"............................................."+term.NORMAL+term.NORMAL
		print' [+] Programmed by GrandFather	'
		print' [+] Greetings To :	'
...
#igzikyut
	if len(sys.argv) < 3:
		...
		if sys.argv[2]=="help":
			...
			os.system('ping localhost -n 2 > nul')
			print'@GrandFamily [',time.strftime("%X"),']','~ GFDOS is attacking to',str(sys.argv[1]),'...'
			if len(sys.argv)== 4:
				if sys.argv[3]=="love":
					set_love()
			url = sys.argv[1]
...
#Some of the codes are leeched but I've changed its functions :D
	...
	if len(sys.argv) !=5:
		print "Usage ~ : GxN.py f |target| |userlist| |wordlist|"
		sys.exit(1)
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="h":
		...
		grandfather()
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
#DO_NOT_SHARE_WITH_OTHERS
#DO_NOT_LEECH_PLEASE
#THIS PROGRAM IS NOT YET AN OPEN SOURCE
#THIS PROGRAM MUST NOT BE SHARED
#DO_NOT_SHARE_WITH_OTHERS
#DO_NOT_LEECH_PLEASE
#THIS PROGRAM IS NOT YET AN OPEN SOURCE
#THIS PROGRAM MUST NOT BE SHARED
